...
import { manifest as collectionList } from "./components/CollectionList.manifest.js";
import { manifest as relatedItems } from "./components/RelatedItems.manifest.js";
// Slice 22B will append: detailPage, mediaGallery, keyValueTable.
export const manifests = [collectionGrid, collectionList, relatedItems];
